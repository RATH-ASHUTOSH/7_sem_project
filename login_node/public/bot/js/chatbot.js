...
function botReply(message){
    message_container.innerHTML += `<img src="../bot/images/bot.png" class="botimg"></img><div class="bot">${message}</div>`;
    location.href = '#edge';
}

function selfReply(message){
    message_container.innerHTML += `<img src="../bot/images/user.png" class="selfimg"></img><div class="self">${message}</div>`;
    location.href = '#edge';
