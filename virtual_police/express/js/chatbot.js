...
function botReply(message){
    message_container.innerHTML += `<img src="/images/bot.png" class="botimg"></img><div class="bot">${message}</div>`;
    
}

function selfReply(message){
    message_container.innerHTML += `<img src="/images/user.png" class="selfimg"></img><div class="self">${message}</div>`;
